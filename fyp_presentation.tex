...
\begin{frame}
	...
	\begin{columns}[T]
		\begin{column}{0.47\textwidth}
			...
			{\tiny
			\begin{tabular}{@{}ll@{}}
				score gate & \(s \geq 0.08\), pass\\
				pose gate & \(\Delta xy < 5\) m and \(\Delta z < 8\) m, pass\\
				replay evidence & 30 accepted factors from 36 scored keyframes
			\end{tabular}}
		\end{column}
		\begin{column}{0.47\textwidth}
			...
			{\tiny
			\begin{tabular}{@{}ll@{}}
				score gate & \(s < 0.08\), fail\\
				support gate & bright-return overlap inconsistent, fail\\
				replay evidence & 447 rejected events, including 6 score failures
			\end{tabular}}
		\end{column}
	\end{columns}
